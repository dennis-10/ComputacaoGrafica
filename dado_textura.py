...
def LoadTextures():
    ...
    reader = png.Reader(filename='dado.png') # leio arquivo e pego os dados
...
#    glTexParameterf(GL_TEXTURE_2D, GL_TEXTURE_WRAP_T, GL_CLAMP)
    # indica como completo o sólido qd a imagem não couber perfeitamente
...
def ReSizeGLScene(Width, Height):
    ...
    glMatrixMode(GL_PROJECTION)
    glLoadIdentity()
    gluPerspective(45.0, float(Width)/float(Height), 0.1, 100.0) # angulo, razao da tela, e qt distante enxergo
    glMatrixMode(GL_MODELVIEW)
...
def DrawGLScene():
    ...
    glTexCoord2f(2/3, 2/2); glVertex3f(-1.0,  1.0, -1.0)    
    glTexCoord2f(3/3, 2/2); glVertex3f( 1.0,  1.0, -1.0)    
    glTexCoord2f(3/3, 1/2); glVertex3f( 1.0, -1.0, -1.0)   
    ...
    glTexCoord2f(2/3, 1/2); glVertex3f( 1.0, -1.0, -1.0)   
    glTexCoord2f(3/3, 1/2); glVertex3f( 1.0, -1.0,  1.0)   
    glTexCoord2f(3/3, 0.0); glVertex3f(-1.0, -1.0,  1.0)    
    
    # Right face
    glTexCoord2f(0.0, 1/2); glVertex3f( 1.0, -1.0, -1.0)    
    glTexCoord2f(0.0, 2/2); glVertex3f( 1.0,  1.0, -1.0)   
    glTexCoord2f(1/3, 2/2); glVertex3f( 1.0,  1.0,  1.0)    
    glTexCoord2f(1/3, 1/2); glVertex3f( 1.0, -1.0,  1.0)  
